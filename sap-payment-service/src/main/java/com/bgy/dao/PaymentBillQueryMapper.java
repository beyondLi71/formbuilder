...
import com.bgy.entity.po.AccountPayDocHeadPO;
import com.bgy.entity.po.AccountPayDocItemPO;
import com.bgy.entity.po.AccountPayDocSkdwItemPO;
...
public interface PaymentBillQueryMapper {
    ...
    @Results({
                    ...
                    @Result(property = "item", column = "HEADID", javaType = List.class,
                            many = @Many(select = "com.bgy.dao.PaymentBillQueryMapper.queryDetailone")),
                    @Result(property = "skdwItem", column = "HEADID", javaType = List.class,
                            many = @Many(select = "com.bgy.dao.PaymentBillQueryMapper.queryDetailtwo"))
                    })
